...
pub struct Block {
    ...
    #[serde(rename = "parentslot", skip_serializing_if = "Option::is_none")]
    pub parentslot: Option<i64>,
    #[serde(rename = "blocktime", skip_serializing_if = "Option::is_none")]
    pub blocktime: Option<Box<crate::models::Timestamp>>,
    #[serde(rename = "metrics", skip_serializing_if = "Option::is_none")]
    pub metrics: Option<Box<crate::models::BlockMetrics>>,
    #[serde(rename = "programstats", skip_serializing_if = "Option::is_none")]
    pub programstats: Option<Vec<crate::models::BlockProgramstats>>,
    ...
    #[serde(rename = "proposerData", skip_serializing_if = "Option::is_none")]
    pub proposer_data: Option<Box<crate::models::BlockProposerData>>,
