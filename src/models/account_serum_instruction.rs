...
pub struct AccountSerumInstruction {
    ...
    pub market: Option<Box<crate::models::AccountSerumInstructionMarket>>,
...
impl AccountSerumInstruction {
    pub fn new() -> AccountSerumInstruction {
