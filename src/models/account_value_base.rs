...
pub struct AccountValueBase {
    ...
    #[serde(rename = "rentEpoch", skip_serializing_if = "Option::is_none")]
    pub rent_epoch: Option<i32>,
    #[serde(rename = "dataSize", skip_serializing_if = "Option::is_none")]
    pub data_size: Option<i32>,
}

impl AccountValueBase {
    pub fn new() -> AccountValueBase {
        AccountValueBase {
            address: None,
            balance: None,
            executable: None,
